...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-3'>
     <Link to='/'>
     <img src={assets.logo} alt="" className='w-28 sm:w-32 lg:w-40 my-3'/>
     </Link>
     <div>
      {user?
      <div className='flex items-center gap-2 sm:gap-3'>
        ...
        <div className='relative group'>
          <img
         className='w-10 drop-shadow' src={assets.profile_icon} alt="" />
          <div className='absolute hidden group-hover:block
          top-0 right-0 z-10 text-black rounded pt-12'>
            <ul className='blist-none m-0 p-2 bg-white rounded-medium border text-sm'>
